...
couch = Product.create(name: 'Couch', description: "Tim's old couch. It's in great condition!", price: 50, product_status_id: avail.id)
laptop = Product.create(name: 'Laptop', description: "Dave's used 13-inch MacBook Pro", price: 250, product_status_id: avail.id)
clubs = Product.create(name: 'Golf Clubs', description: "Zoe's golf clubs in mint condition. Used only once.", price: 25, product_status_id: sold.id)
champagne = Product.create(name: 'Champagne for Days', description: "Perfect for any and all occasions! 21 and older.", price: 500, product_status_id: sold.id)
